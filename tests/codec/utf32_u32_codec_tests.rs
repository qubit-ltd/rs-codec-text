...
use qubit_codec_text::{
    Charset, CharsetCodec, CharsetDecodeErrorKind, CharsetEncodeResult, Utf32, Utf32U32Codec,
};
...
type EncodeFn =
    unsafe fn(&mut Utf32U32Codec, &char, &mut [u32], usize) -> CharsetEncodeResult<usize>;
