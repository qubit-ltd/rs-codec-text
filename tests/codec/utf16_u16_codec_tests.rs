...
use qubit_codec_text::{
    Charset, CharsetCodec, CharsetDecodeErrorKind, CharsetEncodeResult, Utf16, Utf16U16Codec,
};
...
type EncodeFn =
    unsafe fn(&mut Utf16U16Codec, &char, &mut [u16], usize) -> CharsetEncodeResult<usize>;
