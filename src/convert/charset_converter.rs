...
// =============================================================================
use crate::{
    CharsetCodec, CharsetConvertError, CharsetDecodeError, CharsetDecodeHooks, CharsetDecodePolicy,
    CharsetEncodeError, CharsetEncodeHooks, CharsetEncodePolicy, CharsetEncoder, MalformedAction,
    UnmappableAction,
};
    ...
    E: CharsetCodec,
{
    ...
    pub fn map_transcode_error(&self, error: TranscodeConvertErrorOf<D, E>) -> CharsetConvertError {
        CharsetConvertError::from_transcode_error::<D, E>(
            self.source_charset(),
            self.target_charset(),
            error,
        )
