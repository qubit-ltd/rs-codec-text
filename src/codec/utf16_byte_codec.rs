...
impl Codec for Utf16ByteCodec {
    ...
    const MAX_ENCODE_UNITS_PER_VALUE: usize = Utf16::MAX_BYTES_PER_CHAR;

    const MAX_DECODE_UNITS_PER_VALUE: usize = Utf16::MAX_BYTES_PER_CHAR;
...
fn decode_bytes_prefix(
    ...
    if Utf16::is_high_surrogate(first) {
        ...
        Err(CharsetDecodeError::new(charset, kind, index).with_consumed(qubit_utils::nonzero(2)))
    } else {
